...
public class EmailConfig {
    ...
    public static final String FROM = "casiddhesh14@gmail.com";
    public static final String PASSWORD = "Siddhesh@97";

    public static final String[] TO = {"casiddhesh1421@gmail.com"};
